...
\begin{itemize}
  \item Simulate an A* path between $P_i$'s source and destination, considering the presence of 
  ...
  \item If $P_i$ experiences a collision during the simulation, then restart the simulation. On this new
    simulation, add an obstacle for the A* path where the collision took place.
\end{itemize}
